...
import dramaticMateBg from '../assets/mate-dramatico-bg.jpg'; 
// Logo de la marca
    ...
    >
      <div className="login-card-container">
        ...
        <div className="login-card">
          ...
          <button className="login-btn-google-pro">
            <span className="google-icon-pro">G</span> Continuar con Google
          </button>
        ...
        {/* Enlace de navegación (fuera de la tarjeta para mantenerla limpia) */}
        <Link to="/producto/imperial" className="debug-link-centered">
